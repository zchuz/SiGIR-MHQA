...
from bge_large.utils import format_data, pooling
...
if __name__ == "__main__":
    ...
    for idx in trange(0, len(datas), batch_size):
        ...
        with torch.no_grad():
            ...
            batch_embeddings = pooling(batch_outputs)
            #batch_embeddings = batch_outputs[0][:, 0]
            # batch_embeddings = pooling(batch_outputs.last_hidden_state, batch_encodings["attention_mask"])
    ...
    # Save embeddings
    save_path = f"/share/home/zchu/codes/bm25/service/bge_large/prebuild_index/{args.dataset}_embeddings.pt"
