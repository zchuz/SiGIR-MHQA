...
def main(args):
    ...
    # train = json.load(open('../../../data/2wiki/train.json', "r"))
    # dev = json.load(open('../../../data/2wiki/dev.json', "r"))
    # test = json.load(open('../../../data/2wiki/test.json', "r"))
    ...
    # json.dump(data, open('2wiki_241128.json', 'w'), indent = 2)
    # print(len(data))
    # print(len(hist))
    ...
    wikipedia_data = json.load(open('/PATH/TO/CORPUS/2wikimqa.json'))
