...
def main(args):
    ...
    #             wikipedia_data.append({'id': tot, 'text': p['paragraph_text'], 'title': p['title']})
    #             hist.add(stamp)
    #             tot += 1

    #         # print(data[-1])
    #     # break
    # json.dump(wikipedia_data, open('musique_241128.json', 'w'), indent = 2)
    ...
    print(f"{len(train) + len(dev) + len(test)} entries in total")
