...
WIKIPEDIA_INDEX_NAME='musique_241128'
...
if __name__ == '__main__':
    ES = ElasticSearch()
    app.run(host='0.0.0.0', port=1460, threaded = True)

'''
if __name__=='__main__':
    ES = ElasticSearch()
    question = "The Hobbit >> part of the series"
    contexts = ES.search(question)
    print(contexts)
'''
