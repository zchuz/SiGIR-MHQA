...
PREBUILD_INDEX_DICT = {
    "2wikimqa" : "/share/home/zchu/codes/bm25/service/contriever/prebuild_index/2wikimqa_embeddings.pt",
    "hotpotqa" : "/share/home/zchu/codes/bm25/service/contriever/prebuild_index/hotpotqa_embeddings.pt",
    "musique" : "/share/home/zchu/codes/bm25/service/contriever/prebuild_index/musique_embeddings.pt"
}
...
if __name__ == "__main__":
    ...
    model = AutoModel.from_pretrained("//share/home/zchu/pretrained/retriever_models/contriever-msmarco").cuda().eval()
    tokenizer = AutoTokenizer.from_pretrained("/share/home/zchu/pretrained/retriever_models/contriever-msmarco")
    
    uvicorn.run(app, host="0.0.0.0", port=2440)
    print("Contriever server started on port 2440")
